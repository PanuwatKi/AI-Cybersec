# 🛡️ AI คัดกรองสายมิจฉาชีพ 3 สี (Scam Call Detector)
...
- **ความแม่นยำ ~94%** (วัดด้วย Cross-Validation 5 รอบ) ครอบคลุมมิจฉาชีพ 14+ ประเภท
...
| `predict.py` | ระบบสาธิต (โหมดพิมพ์ / เสียง / ต่อบอร์ด Arduino) |
| `arduino_unoq_modulino.ino` | โค้ดฝั่ง Arduino คุมไฟ Modulino Pixels + Buzzer |
| `Dataset1–5.csv` | ข้อมูลฝึก AI (เพิ่มไฟล์ใหม่ได้ ระบบโหลดอัตโนมัติ) |
| `requirements.txt` / `requirements-audio.txt` | รายการไลบรารี |
| `TEAM_GUIDE.md` | คู่มือทีมฉบับเต็ม (การทำงาน, จุดเด่น/ด้อย, วันงาน, แนวตอบกรรมการ) |
